 ...
 */
@CreoleResource(
        name = "OLD:GATE Gzipped Bdoc/JSON Format", 
        isPrivate = true,
        autoinstances = {@AutoInstance(hidden = true)},
        comment = "OLD:Format Bdoc/JSON, GZIP compressed",
...
@Override
  public Resource init() throws ResourceInstantiationException {
    MimeType mime = new MimeType("text", "old_bdocjs+gzip");
    mimeString2ClassHandlerMap.put(mime.getType() + "/" + mime.getSubtype(),this);
    mimeString2mimeTypeMap.put(mime.getType() + "/" + mime.getSubtype(), mime);
    suffixes2mimeTypeMap.put("old_bdocjs.gz", mime);
    setMimeType(mime);
    return this;
  }
  ...
  public void cleanup() {
    ...
    suffixes2mimeTypeMap.remove("old_bdocjs.gz");
  }
