...
import gate.lib.basicdocument.docformats.YamlFormatSupportMap;
...
/**
 * Output handler for the Bdoc Yaml format.
 * 
 * @author Johann Petrak
 */
public class BdocYamlOutputHandler extends AbstractFileOutputHandler {
          ...
          throws IOException, GateException 
  {
    ...
    if(!configData.containsKey(PARAM_FILE_EXTENSION)) {
      configData.put(PARAM_FILE_EXTENSION, ".bdocym");
    }
    super.configImpl(configData);
  }
  
  /**
   * How to output as Bdoc YAML document.
   *
